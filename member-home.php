...
?>
<main>
	<h3><?= $action->trans->read("member-home", "info") ?></h3>
	<div class="member-infos">
		<ul>
			<li><?= $action->trans->read("member-home", "complete") ?> <?= $action->member_nb_completed ?> <?= $action->trans->read("member-home", "workshops") ?></li>
			<li><?= $action->trans->read("member-home", "cummule") ?><?= $action->member_pts ?> <?= $action->trans->read("member-home", "pts") ?></li>
		</ul>
	</div>
