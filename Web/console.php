...
?>
	...
	<div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
		<a class="nav-item nav-link <?php if($action->pageUsers) echo 'active';?>" id="nav-users-tab" data-toggle="tab" href="#nav-users" role="tab" aria-controls="nav-users" aria-selected="true">Users</a>
		<a class="nav-item nav-link <?php if($action->pageWorkshops) echo 'active';?>" id="nav-workshops-tab" data-toggle="tab" href="#nav-workshops" role="tab" aria-controls="nav-workshops" aria-selected="true">Workshops</a>
	</div>

	<div class="tab-content" id="nav-tabContent">
		<div class="tab-pane fade <?php if($action->pageWorkshops) echo "active" ?>" id="nav-workshops" role="tabpanel" aria-labelledby="nav-workshops-tab" >
		...
		<div class="tab-pane fade <?php if($action->pageUsers) echo "active" ?>" id="nav-users" role="tabpanel" aria-labelledby="nav-users-tab" >
			<div class="management-tab">
